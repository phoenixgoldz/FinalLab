...
namespace phoenix
{
	struct Vector3
	{
		...
		Vector3 operator + (const Vector3& v) const { return Vector3{ this->x + v.x, this->y + v.y, this->z + v.z }; } // add
		Vector3 operator - (const Vector3& v) const { return Vector3{ this->x - v.x, this->y - v.y , this->z - v.z }; } //subtract
		Vector3 operator * (const Vector3& v) const { return Vector3{ this->x * v.x, this->y * v.y, this->z * v.z }; } // multiply
		Vector3 operator / (const Vector3& v) const { return Vector3{ this->x / v.x, this->y / v.y , this->z / v.z }; } // divide

		//scale models = // Vector3 = Vector3 + float
